...
print ("%s sentences in training data" % len(trainingdata.training_data))
words = []
classes = []
documents = []
ignore_words = ['?']
for pattern in trainingdata.training_data:
...
net=train(X, y, hidden_neurons=20, alpha=0.1, epochs=100000, dropout=False, dropout_percent=0.2)
